...
//go:noescape
func wasmimport_TCPSocketAccept(self0 uint32, result *ResultTupleTCPSocketInputStreamOutputStreamErrorCode)
...
//go:noescape
func wasmimport_TCPSocketFinishBind(self0 uint32, result *ResultErrorCode)

//go:wasmimport wasi:sockets/tcp@0.2.0 [method]tcp-socket.finish-connect
//go:noescape
func wasmimport_TCPSocketFinishConnect(self0 uint32, result *ResultTupleInputStreamOutputStreamErrorCode)

//go:wasmimport wasi:sockets/tcp@0.2.0 [method]tcp-socket.finish-listen
//go:noescape
func wasmimport_TCPSocketFinishListen(self0 uint32, result *ResultErrorCode)

//go:wasmimport wasi:sockets/tcp@0.2.0 [method]tcp-socket.hop-limit
//go:noescape
func wasmimport_TCPSocketHopLimit(self0 uint32, result *ResultU8ErrorCode)
